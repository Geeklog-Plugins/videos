...
$GLOBALS['VIDEOS_UPDATES'] = array(
    ...
    '0.6.0' => array(
        'next' => '0.6.1',
        'callback' => 'videos_update_0_6_0_to_0_6_1'
    ),
    '0.6.1' => array(
        'next' => '0.6.2',
        'callback' => ''
    ...
    '0.6.3' => array(
        'next' => '0.6.4',
        'callback' => 'videos_update_0_6_3_to_0_6_4'
    ),
    '0.6.4' => array(
        'next' => '0.7.0',
        'callback' => ''
    ...
    '0.7.1' => array(
        'next' => '0.8.0',
        'callback' => 'videos_update_0_7_1_to_0_8_0'
    ),
    '0.8.0' => array(
        'next' => '0.8.1',
        'callback' => ''
    ...
    '0.9.0' => array(
        'next' => '0.10.0',
        'callback' => 'videos_update_0_9_0_to_0_10_0'
    ),
    '0.10.0' => array(
        'next' => '0.10.1',
        'callback' => 'videos_update_0_10_0_to_0_10_1'
    ),
    '0.10.1' => array(
        'next' => '0.10.2',
        'callback' => ''
    ...
    '0.10.5' => array(
        'next' => '0.11.0',
        'callback' => 'videos_update_0_10_5_to_0_11_0'
    ),
    '0.11.0' => array(
        'next' => '0.12.0',
        'callback' => ''
    ...
    '0.13.0' => array(
        'next' => '0.14.0',
        'callback' => 'videos_update_0_13_0_to_0_14_0'
    ),
    '0.14.0' => array(
        'next' => '0.14.1',
        'callback' => 'videos_update_0_14_0_to_0_14_1'
    ),
    '0.14.1' => array(
        'next' => '0.15.0',
        'callback' => 'videos_update_0_14_1_to_0_15_0'
    ),
    '0.15.0' => array(
        'next' => '0.15.1',
        'callback' => ''
    ...
    '0.15.1' => array(
        'next' => '0.16.0',
        'callback' => 'videos_update_0_15_1_to_0_16_0'
    ),
    '0.16.0' => array(
        'next' => '0.16.1',
        'callback' => 'videos_update_0_16_0_to_0_16_1'
    ),
    '0.16.1' => array(
        'next' => '0.16.2',
        'callback' => 'videos_update_0_16_1_to_0_16_2'
    ),
    '0.16.2' => array(
        'next' => '0.16.3',
        'callback' => ''
    ...
    '0.16.3' => array(
        'next' => '0.16.4',
        'callback' => 'videos_update_0_16_3_to_0_16_4'
    ),
    '0.16.4' => array(
        'next' => '0.16.5',
        'callback' => 'videos_update_0_16_4_to_0_16_5'
    ),
    '0.16.5' => array(
        'next' => '0.17.0',
...
function videos_update_0_15_1_to_0_16_0()
{
    ...
    $tabExists = DB_getItem(
        $_TABLES['conf_values'],
        'COUNT(*)',
        "name = '$tabName' AND group_name = '$group'"
    );
    if ((int) $tabExists === 0) {
        $configuration->add(
            'tab_seo',
    ...
    $fieldsetExists = DB_getItem(
        $_TABLES['conf_values'],
        'COUNT(*)',
        "name = '$fieldsetName' AND group_name = '$group'"
    );
    ...
    if (empty($featureId)) {
        DB_query(
            "INSERT INTO {$_TABLES['features']} (ft_name, ft_descr) VALUES ('"
            . $escapedFeature . "', 'Configure public-page SEO')"
        );
        if (DB_error()) {
            return false;
        }
    ...
    $groupId = DB_getItem(
        $_TABLES['groups'],
        'grp_id',
        "grp_name = '" . DB_escapeString('Videos Admin') . "'"
    );
...
function videos_update_0_14_0_to_0_14_1()
{
    ...
    $current = $configuration->get_config('videos');
    if (is_array($current) &&
        array_key_exists('short_filter_mode', $current)) {
        return true;
    }
    $configuration->add(
        'short_filter_mode',
    ...
    return is_array($updated) &&
        array_key_exists('short_filter_mode', $updated);
}
...
function videos_update_0_13_0_to_0_14_0()
{
    ...
    $updated = $configuration->get_config('videos');
    return is_array($updated) &&
        array_key_exists('exclude_short_videos', $updated) &&
        array_key_exists('short_max_duration', $updated);
}
...
function videos_update_0_10_5_to_0_11_0()
{
    ...
    $current = $configuration->get_config('videos');
    if (is_array($current) &&
        array_key_exists('availability_cache_ttl', $current)) {
        return true;
    }
    $configuration->add(
    ...
    $updated = $configuration->get_config('videos');
    return is_array($updated) &&
        array_key_exists('availability_cache_ttl', $updated);
}
...
function videos_update_0_10_0_to_0_10_1()
{
    ...
    DB_query(
        ...
        . "SET type = 'select', selectionArray = 3 "
        . "WHERE name = '$name' AND group_name = '$group'"
    );
    if (DB_error()) {
        return false;
    }
    $result = DB_query(
        "SELECT type, selectionArray FROM {$_TABLES['conf_values']} "
        . "WHERE name = '$name' AND group_name = '$group'"
    );
    ...
    return isset($row['type'], $row['selectionArray']) &&
        $row['type'] === 'select' &&
        (int) $row['selectionArray'] === 3;
}
...
function videos_update_0_9_0_to_0_10_0()
{
    ...
    $current = $configuration->get_config('videos');
    if (is_array($current) &&
        array_key_exists('block_item_count', $current)) {
        return true;
    }
    $configuration->add(
        'block_item_count',
    ...
    $updated = $configuration->get_config('videos');
    return is_array($updated) &&
        array_key_exists('block_item_count', $updated);
}
...
function videos_update_0_6_3_to_0_6_4()
{
    ...
    $current = $configuration->get_config('videos');
    if (is_array($current) &&
        array_key_exists('youtube_player_mode', $current)) {
        return true;
    }
    $configuration->add(
        'youtube_player_mode',
    ...
    $updated = $configuration->get_config('videos');
    return is_array($updated) &&
        array_key_exists('youtube_player_mode', $updated);
}
...
function videos_update_0_6_0_to_0_6_1()
{
    ...
    $current = $configuration->get_config('videos');
    if (is_array($current) &&
        array_key_exists('description_mode', $current)) {
        return true;
    }
    $configuration->add(
        'description_mode',
    ...
    $updated = $configuration->get_config('videos');
    return is_array($updated) &&
        array_key_exists('description_mode', $updated);
}

function videos_apply_updates($installedVersion, $targetVersion)
{
    $updates = isset($GLOBALS['VIDEOS_UPDATES']) &&
        is_array($GLOBALS['VIDEOS_UPDATES'])
        ? $GLOBALS['VIDEOS_UPDATES']
        : array();
    ...
    while ($currentVersion !== $targetVersion) {
        if (isset($visited[$currentVersion]) ||
            !isset($updates[$currentVersion])) {
            return false;
        }
        ...
        if (!isset($step['next']) ||
            !is_string($step['next']) ||
            version_compare($step['next'], $currentVersion, '<=')) {
            return false;
        }
        ...
        if (!empty($step['callback'])) {
            if (!is_string($step['callback']) ||
                !function_exists($step['callback']) ||
